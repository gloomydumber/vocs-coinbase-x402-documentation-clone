import{f as r,j as n}from"./index-CETzh_ht.js";const c={title:"퍼실리테이터",description:"undefined"};function i(e){const s={a:"a",div:"div",h1:"h1",h2:"h2",header:"header",li:"li",p:"p",strong:"strong",ul:"ul",...r(),...e.components};return n.jsxs(n.Fragment,{children:[n.jsx(s.header,{children:n.jsxs(s.h1,{id:"퍼실리테이터",children:["퍼실리테이터",n.jsx(s.a,{"aria-hidden":"true",tabIndex:"-1",href:"#퍼실리테이터",children:n.jsx(s.div,{"data-autolink-icon":!0})})]})}),`
